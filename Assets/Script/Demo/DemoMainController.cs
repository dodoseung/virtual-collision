...
public class DemoMainController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ShuffleList = new int[]{0, 4, 8, 12, 12};
    ...
    void Update()
    {
        TargetCollision = TargetController.GetComponent<DemoTargetController>().TargetCollision;
    ...
    public void VariableSetup()
    {
        ...
        this.GetComponent<DemoSphereController>().Integration = Integration;
        TargetController.GetComponent<DemoTargetController>().TargetVelocity = TargetVelocity;
        this.GetComponent<DemoSphereController>().Friction = Friction;
        this.GetComponent<DemoSphereController>().Bounciness = Bounciness;
